                      ...
                      child: IconButton(
                        ...
                        onPressed: () {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                  content: Text(
                                      'This button is for future improvment')));
                        },
                      ),
                    ),
                  ],
                        ...
                        Row(children: [
                          ...
                          Container(
                            ...
                            child: IconButton(
                              //start date icon
                              onPressed: () {
                                //start get date from user
                                showDatePicker(
                                        context: context,
                                        initialDate:
                                            DateTime.now(), //default date
                                        firstDate: DateTime
                                            .now(), //limit the date, the start
                                        lastDate: DateTime(2023, 1,
                                            29)) //limit the date the end
                                    .then((value) {
                                  setState(() {
                              ...
                              icon: Icon(Icons
                                  .edit_calendar_outlined), // end date icon
