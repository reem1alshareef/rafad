...
class _Delete_my_accountState extends State<Delete_my_account> {
  ...
  class Delete_my_account_campaign extends StatefulWidget {
  const Delete_my_account_campaign({super.key});

  @override
  State<Delete_my_account_campaign> createState() => _Delete_my_account_campaignState();
}

class _Delete_my_account_campaignState extends State<Delete_my_account_campaign> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
          body: SingleChildScrollView(
